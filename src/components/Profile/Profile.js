                ...
                <form className="profile__form">
                    ...
                    <fieldset className="profile__inputs">
                        <div className="profile__field">
                            ...
                            <input className="profile__input profile__input-name" defaultValue="Дмитрий"></input>
                            <span className="profile__error"></span>
                        </div>
                        <div className="profile__field">
                            <p className="profile__label profile__label-mail">E-mail</p>
                            <input className="profile__input profile__input-mail" defaultValue="dmitry_wattt@mail.ru"></input>
                            <span className="profile__error"></span>
                        </div>
                    </fieldset>
